@extends('layouts.app')
@section('title', 'AlpineJS')
@section('content')
    <main>
        <section class="py-5 text-center container">
            <div class="row py-lg-5">
                <div class="col-lg-6 col-md-8 mx-auto">
                    <img src="https://alpinejs.dev/alpine_long.svg" width="200rem" alt="" srcset="">
                    ...
                    <p>
                        <a target="_blank" rel="noopener noreferrer" href="https://alpinejs.dev/"
                        ...
                        <div class="card shadow-sm">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="btn-group">
                                        <button type="button" class="btn btn-sm btn-outline-secondary" data-bs-toggle="modal" data-bs-target="#alpinejs-livewire-timer">View</button>
                                    </div>
                                    <small class="text-muted">AlpineJS</small>
                                </div>
                            </div>
                        </div>
                    </div>
